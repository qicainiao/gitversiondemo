<template>
  <demo-section>
    <demo-block :title="$t('basicUsage')">
      <jy-picker :columns="$t('column1')" @change="onChange1" />
    </demo-block>

    <demo-block :title="$t('defaultIndex')">
      <jy-picker :columns="$t('column1')" :default-index="2" @change="onChange1" />
    </demo-block>
    ...
    <demo-block :title="$t('title2')">
      <jy-picker :columns="$t('column2')" />
    </demo-block>

    <demo-block :title="$t('title4')">
      <jy-picker :columns="columns" @change="onChange2" />
    </demo-block>

    <demo-block :title="$t('loadingStatus')">
      <jy-picker loading :columns="columns" />
    </demo-block>
  </demo-section>
</template>
