<template>
  <demo-section>
    ...
    <demo-block :title="$t('customContent')">
      <jy-tree-select height="55vw" :items="simpleItems" :main-active-index.sync="activeIndex3">
        <template slot="content">
          <jy-image v-if="activeIndex3 === 0" src="https://img.yzcdn.cn/jyt/apple-1.jpg" />
          <jy-image v-if="activeIndex3 === 1" src="https://img.yzcdn.cn/jyt/apple-2.jpg" />
        </template>
      </jy-tree-select>
    </demo-block>

    <demo-block :title="$t('showInfo')">
      <jy-tree-select height="55vw" :items="infoItems" :active-id.sync="activeId2" :main-active-index.sync="activeIndex4" />
    </demo-block>
  </demo-section>
</template>
