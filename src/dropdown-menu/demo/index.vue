<template>
  <demo-section>
    ...
    <demo-block :title="$t('customContent')">
      <jy-dropdown-menu>
        <jy-dropdown-item v-model="value1" :options="option1" />
        <jy-dropdown-item :title="$t('itemTitle')" ref="item">
          <jy-switch-cell v-model="switch1" :title="$t('switchTitle1')" />
          <jy-switch-cell v-model="switch2" :title="$t('switchTitle2')" />
          <jy-button type="info" block @click="onConfirm">{{ $t('confirm') }}</jy-button>
        </jy-dropdown-item>
      </jy-dropdown-menu>
    </demo-block>
