<template>
  <demo-section>
    <demo-block :title="$t('ellipsis')">
      <div class="jy-ellipsis">{{ $t('text1') }}</div>
      <div class="jy-multi-ellipsis--l2">{{ $t('text2') }}</div>
    </demo-block>

    <demo-block :title="$t('hairline')">
      <div class="jy-hairline--top" />
    </demo-block>
    ...
    <demo-block :title="$t('animation')">
      <jy-cell
        is-link
        title="Fade"
        @click="animate('jy-fade')"
      />
      <jy-cell
        is-link
        title="Slide Up"
        @click="animate('jy-slide-up')"
      />
      <jy-cell
        is-link
        title="Slide Down"
        @click="animate('jy-slide-down')"
      />
      <jy-cell
        is-link
        title="Slide Left"
        @click="animate('jy-slide-left')"
      />
      <jy-cell
        is-link
        title="Slide Right"
        @click="animate('jy-slide-right')"
      />
    </demo-block>
