...
// CONCATENATED MODULE: ./es/buttonmy/index.js
...
var buttonmy_createNamespace = Object(create["a" /* createNamespace */])('button'),
    buttonmy_createComponent = buttonmy_createNamespace[0],
    buttonmy_bem = buttonmy_createNamespace[1];

function MyButton(h, props, slots, ctx) {
  var _ref;
  ...
  var classes = [buttonmy_bem([type, props.size, {
    plain: plain,
    disabled: disabled,
    hairline: hairline,
    block: props.block,
...
MyButton.props = _extends({}, routeProps, {
  text: String,
  icon: String,
  color: String,
  block: Boolean,
...
/* harmony default export */ var buttonmy = (buttonmy_createComponent(MyButton));
...
/* concated harmony reexport Buttonmy */__webpack_require__.d(__webpack_exports__, "Buttonmy", function() { return buttonmy; });
